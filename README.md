    ...
    └── view/
        ...
        └── windows/
            └── EquipmentWindow.java
                ...
                UserWindow.java
```
Class Reference: A complete description of the codebase, including the Model entities, View components, and Controller logic, is available in the [Javadoc Documentation]().
